...
<body>
    ...
    <script>
        ...
        window.addEventListener('pagehide', function() {
            const isSubmitting = sessionStorage.getItem(REGISTER_SUBMITTING_FLAG) === 'true';
            if (!isSubmitting) {
                sessionStorage.removeItem(TERMS_FLAG);
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const termsAccepted = sessionStorage.getItem(TERMS_FLAG) === 'true';
            if (!termsAccepted) {
                showTermsModal();
            }
